...
int main()
{
	...
	Shader shader("./shaders/reflectShader.vs", "./shaders/reflectShader.fs");
	Shader skyboxShader("./shaders/skybox.vs", "./shaders/skybox.fs");
	Shader nanoShader("./shaders/nanoShader.vs", "./shaders/nanoShader.fs");
	...
	nanoShader.use();
	nanoShader.setInt("texture_diffuse1", 0);
	Model mymodel("./resource/nanosuit_reflection/nanosuit.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//nano
		nanoShader.use();
		nanoShader.setMatrix4fv("model", 1, GL_FALSE, model);
		nanoShader.setMatrix4fv("view", 1, GL_FALSE, view);
		nanoShader.setMatrix4fv("projection", 1, GL_FALSE, projection);
		mymodel.Draw(nanoShader);
